...
echo exit | D:\app\oracle\product\11.2.0\dbhome_1\BIN\sqlplus.exe -S sys/manager@ORCL as sysdba @C:\temp\OSCommand.jvs.sql

echo exit | D:\app\oracle\product\11.2.0\dbhome_1\BIN\sqlplus.exe -S sys/manager@ORCL as sysdba @C:\temp\OSCMD.fnc.sql

echo exit | D:\app\oracle\product\11.2.0\dbhome_1\BIN\sqlplus.exe -S sys/manager@ORCL as sysdba @C:\temp\OSCMD-EXTRA.SQL
